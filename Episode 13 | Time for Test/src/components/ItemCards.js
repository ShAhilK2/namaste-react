...
function ItemCards({ items }) {
  ...
  return (
    <div className="flex flex-col">
      {items.map(item => (
        <div key={item.card.info.id} className="p-4 m-2 border-b border-gray-300 flex justify-between items-start transition-transform transform hover:scale-105" data-testid="resMenuList">
