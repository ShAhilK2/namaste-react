...
if(onlineStatus === false) {
  ...
  return (
( restaurantList && restaurantList.length === 0) ? <Shimmer /> :

    <div className="body">
        <div className="flex">
        <div className="search">
        <input type="text" placeholder="Search" className="m-4 p-4 border border-black " value={searchText} data-testid="searchInput" onChange={(e)=>{
